    ...
    <>
      ...
      <div className="legal-text-center">
        <div className="privacy-policy">
          ...
          <p>
            QUE BARBADA LTDA built the Que Barbada app as a Free app. This
            SERVICE is provided by QUE BARBADA LTDA at no cost and is intended
            ...
            is accessible at Que Barbada unless otherwise defined in this
            Privacy Policy.
          </p>
          ...
          <p>
            ...
            including but not limited to Name, Addresses, Phone numbers, Asset
            information, Personal identification number, Camera, Images,
            Geographical location, Date of birth, Personal features. The
          ...
          <p>
            ...
            page. This policy is effective as of 2021-10-05
          </p>
          <h2>Contact Us</h2>
          <p>
            If you have any questions or suggestions about our Privacy Policy,
            do not hesitate to contact us at contato@quebarbada.com.
          </p>
          <h1>Política de Privacidade em Português</h1>
          <p>
            A QUE BARBADA LTDA construiu o aplicativo Que Barbada como um
            aplicativo gratuito. Este SERVIÇO é prestado pela QUE BARBADA LTDA
            sem nenhum custo e deve ser utilizado no estado em que se encontra.
            Esta página é usada para informar os visitantes sobre nossas
            políticas de coleta, uso e divulgação de Informações Pessoais, caso
            alguém decida usar nosso Serviço. Se você optar por usar nosso
            Serviço, você concorda com a coleta e uso de informações em relação
            a esta política. As informações pessoais que coletamos são usadas
            para fornecer e melhorar o serviço. Não usaremos ou compartilharemos
            ...
            Condições, que podem ser acessados no Que Barbada, a menos que
          ...
          <p>
            ...
            incluindo, mas não se limitando a, nome, endereços, números de
            telefone, informações de ativos, número de identificação pessoal,
            câmera, imagens, localização geográfica, data de nascimento,
            características pessoais. As informações que solicitamos serão
            retidas por nós e usadas conforme descrito nesta política de
            privacidade. O aplicativo usa serviços de terceiros que podem
            coletar informações usadas para identificá-lo. Link para a política
          ...
          <p>
            Queremos informar que sempre que você utiliza nosso Serviço, em caso
          ...
          <p>
            ...
            não divulgar ou usar as informações para qualquer outra finalidade.
          </p>
          <h2>Segurança</h2>
          <p>
          ...
          <p>
            ...
            Esta política está em vigor a partir de 05-10-2021
          </p>
          <h2>Entre em contato conosco</h2>
          <p>
            Se você tiver alguma dúvida ou sugestão sobre nossa Política de
            Privacidade, não hesite em nos contatar em contato@quebarbada.com
          </p>
        </div>
      </div>
      <Footer />
